...
+(NSString*)changeLanguageUTF8:(NSString*)chinese{
    NSString *strResult;
    NSData *data=[chinese dataUsingEncoding:NSUTF8StringEncoding];
    strResult=[[NSString alloc]initWithData:data encoding:NSUTF16StringEncoding];
    return strResult;
}
+ (NSArray *)allEmoticons {
//    [self ToHex:]
//    NSString *ste=[NSString str]
//[NSUTF16StringEncoding ]
//    [NSString string]
//     NSString* s = [NSStringstringWithContentsOfFile:path encoding:enc error:&err];
//    [self changeLanguageUTF8]
