...
#import "Articlecomment_cell.h"

#import "Tools.h"
#import "comment_model_alter.h"

@implementation Articlecomment_cell
{
    DBImageView *headImg;
    UILabel *_content;
    UIView *_footView;
    ...
    for (int i=0; i<_view_array.count; i++) {
        ...
        }else
        {
            ...
            if(i==2)
            {
                ...
                _label.font=[regular getFont:10.0f];
                
            }else if(i==0)
            {
//                long time= [cell_model.delivertime longLongValue];
//                //    将时间转化成时间戳
//                
...
//
//                NSString *context4 = [fmt stringFromDate:nsdate];
