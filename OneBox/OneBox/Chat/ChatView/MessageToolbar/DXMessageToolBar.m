...
- (void)setupSubviews
{
    ...
    self.styleChangeButton = [[UIButton alloc] initWithFrame:CGRectMake(kHorizontalPadding+4.5, kVerticalPadding+4.5, kInputTextViewMinHeight-9, kInputTextViewMinHeight-9)];
    ...
    //更多
    self.moreButton = [[UIButton alloc] initWithFrame:CGRectMake(CGRectGetWidth(self.bounds) - kHorizontalPadding - kInputTextViewMinHeight+4.5, kVerticalPadding+4.5, kInputTextViewMinHeight-9, kInputTextViewMinHeight-9)];
//    self.moreButton.backgroundColor=[UIColor redColor];
    ...
    //表情
    self.faceButton = [[UIButton alloc] initWithFrame:CGRectMake(CGRectGetMinX(self.moreButton.frame) - kInputTextViewMinHeight - kHorizontalPadding+4.5*2, kVerticalPadding+4.5, kInputTextViewMinHeight-9, kInputTextViewMinHeight-9)];
//    self.faceButton.backgroundColor=[UIColor redColor];
    ...
    _inputTextView.placeHolder = NSLocalizedString(@"message.toolBar.inputPlaceHolder", @"");
    _inputTextView.delegate = self;
    _inputTextView.font=[regular get_en_Font:15.0f];
    ...
    //录制
     self.recordButton = [[UIButton alloc] initWithFrame:CGRectMake(textViewLeftMargin+4.5, kVerticalPadding+4.5, width-9, kInputTextViewMinHeight-9)];
    self.recordButton.titleLabel.font = [regular getFont:15.0f];
    ...
    if (!self.recordView) {
        ...
        self.recordView.backgroundColor=[UIColor colorWithRed:235.0f/255.0f green:235.0f/255.0f blue:235.0f/255.0f alpha:1];
    }
    ...
    if ([[AVAudioSession sharedInstance] respondsToSelector:@selector(requestRecordPermission:)]) {
        [[AVAudioSession sharedInstance] requestRecordPermission:^(BOOL granted) {
            if (granted) {
                ...
                //                [[ToolManager sharedManager] alertTitle_Simple:@"允许使用麦克风！"];
