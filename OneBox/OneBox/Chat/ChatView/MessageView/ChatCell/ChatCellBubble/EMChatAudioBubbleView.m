...
- (id)initWithFrame:(CGRect)frame
{
    if (self = [super initWithFrame:frame]) {
        _animationImageView = [[UIImageView alloc] initWithFrame:CGRectMake(0, 0, ANIMATION_IMAGEVIEW_SIZE*(CGFloat)(81.0f/130.0f), ANIMATION_IMAGEVIEW_SIZE)];
        ...
        [_isReadView setBackgroundColor:[UIColor clearColor]];
...
- (void)setModel:(MessageModel *)model
{
    ...
    if(model.isSender)
    {
        _timeLabel.textColor=[UIColor colorWithRed:83.0f/255.0f green:190.0f/255.0f blue:215.0f/255.0f alpha:1];
    }else
    {
        _timeLabel.textColor=[UIColor whiteColor];
