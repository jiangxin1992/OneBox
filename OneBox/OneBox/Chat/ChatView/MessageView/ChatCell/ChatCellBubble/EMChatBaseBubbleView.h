...
#define BUBBLE_ARROW_WIDTH 2 // bubbleView中，箭头的宽度
#define BUBBLE_VIEW_PADDING 12 // bubbleView 与 在其中的控件内边距

#define BUBBLE_RIGHT_LEFT_CAP_WIDTH 6 // 文字在右侧时,bubble用于拉伸点的X坐标
#define BUBBLE_RIGHT_TOP_CAP_HEIGHT 27.5 // 文字在右侧时,bubble用于拉伸点的Y坐标

#define BUBBLE_LEFT_LEFT_CAP_WIDTH 30 // 文字在左侧时,bubble用于拉伸点的X坐标
#define BUBBLE_LEFT_TOP_CAP_HEIGHT 28.5 // 文字在左侧时,bubble用于拉伸点的Y坐标
