...
- (id)initWithFrame:(CGRect)frame
{
    if (self = [super initWithFrame:frame]) {
        ...
        _textLabel.font = [regular getFont:LABEL_FONT_SIZE];
...
- (void)setModel:(MessageModel *)model
{
    ...
    if(model.isSender)
    {
        _textLabel.textColor=[UIColor colorWithRed:83.0f/255.0f green:190.0f/255.0f blue:215.0f/255.0f alpha:1];
    }else
    {
...
{
    return [regular getFont:LABEL_FONT_SIZE];
}
