...
{
//    _headImageView.frame=CGRectMake(CGRectGetMinX(_headImageView.frame), height-HEAD_PADDING-CGRectGetHeight(_headImageView.frame), CGRectGetWidth(_headImageView.frame), CGRectGetHeight(_headImageView.frame));
}
-(void)layoutSubviews
{
...
- (void)setMessageModel:(MessageModel *)messageModel
{
    ...
    _nameLabel.font=[regular get_en_Font:12.0f];
    UIImage *placeholderImage = [UIImage imageNamed:@"headImg_login1"];
