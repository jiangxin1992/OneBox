...
- (void)setMessageModel:(MessageModel *)model
{
    ...
    if (model.messageType != eMessageTypeChat) {
        ...
        _nameLabel.font=[regular get_en_Font:13.0f];
...
//        [_retryButton setImage:[UIImage imageNamed:@"messageSendFail.png"] forState:UIControlStateNormal];
        ...
        _hasRead.textColor=[UIColor clearColor];
        _hasRead.font = [regular get_en_Font:12.0f];
        [_hasRead sizeToFit];
...
- (EMChatBaseBubbleView *)bubbleViewForMessageModel:(MessageModel *)messageModel
{
    switch (messageModel.type) {
        ...
        {
            EMChatTextBubbleView *ChatText=[[EMChatTextBubbleView alloc] init];
            ChatText.model=messageModel;
            return ChatText;
        }
            break;
