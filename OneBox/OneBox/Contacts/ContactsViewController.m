...
- (NSMutableArray *)sortDataArray:(NSArray *)dataArray
{
    ...
    for (EMBuddy *buddy in dataArray) {
        ...
        NSString *firstLetter = [ChineseToPinyin pinyinFromChiniseString:buddy.username];
    ...
    for (int i = 0; i < [sortedArray count]; i++) {
        NSArray *array = [[sortedArray objectAtIndex:i] sortedArrayUsingComparator:^NSComparisonResult(EMBuddy *obj1, EMBuddy *obj2) {
            NSString *firstLetter1 = [ChineseToPinyin pinyinFromChiniseString:obj1.username];
            firstLetter1 = [[firstLetter1 substringToIndex:1] uppercaseString];
            
            NSString *firstLetter2 = [ChineseToPinyin pinyinFromChiniseString:obj2.username];
