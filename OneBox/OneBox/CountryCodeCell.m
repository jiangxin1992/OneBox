...
-(void)setDict:(NSDictionary *)dict
{
    ...
    for (int i=0; i<2; i++) {
        ...
        label.frame=CGRectMake(15+i*(ScreenWidth-30)/2.0f,0, _width, 80*_Scale);
        ...
        label.textColor=i==0?[UIColor blackColor]:[UIColor colorWithRed:138.0f/255.0f green:138.0f/255.0f blue:138.0f/255.0f alpha:1];
        if(i==0)
        {
