...
- (UIImage *)trackBackgroundImage
{
    if(_trackBackgroundImage==nil)
    {
        ...
        image = [image resizableImageWithCapInsets:UIEdgeInsetsMake(0.0, 2.0, 0.0, 5.0)];
...
- (CGRect)trackRect
{
    ...
    retValue.size = CGSizeMake(_trackImage.size.width, _trackImage.size.height/3.0f);
 ...
 -(CGRect) trackBackgroundRect
{
    ...
    trackBackgroundRect.size = CGSizeMake(_trackBackgroundImage.size.width-4, _trackBackgroundImage.size.height/3.0f);
