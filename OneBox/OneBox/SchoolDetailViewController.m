...
- (void)sharePressBtn:(UIButton *)btn
{
    ...
    [shareParams SSDKSetupShareParamsByText:[[NSString alloc] initWithFormat:@"分享了来自美高盒子的%@",detail_model.cn_name] images:nil url:[NSURL URLWithString:@"https://appsto.re/cn/HYZ77.i"] title:[_data_dict objectForKey:@"schoolName"] type:SSDKContentTypeAuto];
