...
-(CGRect)imageRectForContentRect:(CGRect)contentRect
{
    ...
    {
        //为box的时候
        return CGRectMake((ScreenWidth/5.0f-32)/2.0f, (tabbarHeight-32)/2.0f, 32, 32);
    }else if(self.type==0)
    {
        return CGRectMake((ScreenWidth/5.0f-32)/2.0f, (tabbarHeight-32)/2.0f, 32 , 32);
    }else if(self.type==2)
    {
        return CGRectMake((ScreenWidth/5.0f-18)/2.0f, (tabbarHeight-18)/2.0f, 18 , 18);
    }else if(self.type==4)
    {
        return CGRectMake((ScreenWidth/5.0f-18)/2.0f, (tabbarHeight-18)/2.0f, 18 , 18);
    }else
    {
        return CGRectMake((ScreenWidth/5.0f-30)/2.0f, (tabbarHeight-30)/2.0f, 30 , 30);
    }
