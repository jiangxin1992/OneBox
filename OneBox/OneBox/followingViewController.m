...
//    [label setAttributedText:[regular createAttributeString:@"该用户还未添加关注者" andFloat:@(2.0)]];
...
- (void)viewDidLoad {
    ...
    self.navigationItem.titleView=[regular returnNavView:@"关注的人" withmaxwidth:230];
    ...
    __block followingViewController *controller = self;
    changeBlock=^(NSNumber *rownum)
    {
        [controller changeblock_action:rownum];
    };
}
-(void)changeblock_action:(NSNumber *)rownum
{
...
-(void)RequestData
{
    ...
    [manager GET:[[NSString alloc] initWithFormat:@"%@/v1/chats/all_followings",DNS] parameters:parameters success:^(AFHTTPRequestOperation *operation, id responseObject) {
