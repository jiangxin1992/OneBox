...
-(void)sendComment
{
    ...
    NSDictionary *parameters=@{@"commentable_id":_sid,@"commentable_type":@"school",@"content":_commentField1.text,@"token":_token};
...
-(void)loadData1
{
    ...
    NSDictionary *parameters=@{@"token":_token,@"commentable_id":_sid,@"commentable_type":@"school"};
